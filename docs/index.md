...
相信点开这个网站的你，或多或少对哲学已有所了解。也许，你仅仅读过《苏菲的世界》，只接触过中学政治课本；或者，你是一位历经磨砺的哲学博士，一位早已博览群书的哲学学者。无论如何，我都希望这个网站能为你带来哪怕一点点的启发。

启发（Enlightenment）不单指一个历史时代，更指向哲学的一种核心气质：一种敢于运用自身理性，去审视一切既有观念的决心。

我在开始学习计算机科学时，受到 [CSDIY](https://csdiy.wiki) 的启发，萌生了建立哲学自学网站的想法。但这个网站并不能像 CSDIY 那样，让你获得一种特定的技能或知识。哲学与计算机科学这类工程学科的根本区别在于学习的最终指向。工程学科的学习，其目标往往是改造外部世界，其成果是一个可以运行的程序、一个有效的解决方案。而哲学的学习，其指向更多是重塑我们自身，其成果是我们看待世界和自我的框架的更新，是思考者本人的转变。

因此，在哲学这里，我们并不能通过刷完一套课程来掌握一种可以直接应用的“技能”。哲学的学习，要求我们面对那些可能永远没有确定答案的问题，并在持续的反思中，享受智识上成长的过程本身。

目前我希望做的，是列出哲学各领域最重要的一批书籍与论文，提供一个对当代哲学总体的视野，以及记录我自己的一些想法。而真正的学术性工作，则需要读者自己在特定领域的深入挖掘，以及与同行的深入交流。请把本站看作一张地图而非导航，它可以向你展示地形，但你需要选择自己的路线和节奏。
...
需要说明的是，前言乃至整个网站所呈现的关于“哲学是什么”的描绘，本身就是一种有待审视的立场。我在此提供的，仅仅是当代哲学范式下的一种较为普遍的理解视角。无论是对哲学特征的总结，还是对“做哲学”方式的建议，都并非唯一答案。哲学史上以及不同思想传统中，对这些问题存在着深刻的分歧。因此，我鼓励你将此处的文字也作为一个批判性阅读的起点，而非一个不容置疑的终点。如果未来的你，或现在的你，有充分的理由来质疑、反驳甚至推翻这里的观点，那恰恰证明了你已经走在了“做哲学”的正确道路上。
...
此外我并没有，也不可能将网站上提供的所有资源都完整地学习一遍。这份列表更像是一张基于基本共识和个人判断的“地图”。我来自一所普通的 211 大学哲学系，目前还在挣扎着跨考计算机科学。这与 [@PKUFlyingPig](https://github.com/PKUFlyingPig) 北大信科的身份背书无法比拟。在985遍地走的互联网，这样的背景或许很难立刻赢得你的信任，甚至可能引来一些嗤之以鼻。而论我的学习能力，可以说是平庸；论学习毅力，我也远未达到孜孜不倦的程度。
